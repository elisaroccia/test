...
%% References
% 1) EG Levine, M Saranathan, and B Hargreaves. â€œComplementary Poisson-Disc Samplingâ€? Proceedings of ISMRM, Milan, Italy, May 2014
% 
% 2) EG Levine, B Quist, B Daniel, B Hargreaves, and M Saranathan. â€œView-sharing and Compressed Sensing in Two-Point Dixon-based DCE-MRIâ€? Proceedings of ISMRM, Milan, Italy, May 2014
%
...
figure;
imagesc( M1(:,:,1));
title('Uniform density CPD sampling patterns from "genVDCPD.m"');
